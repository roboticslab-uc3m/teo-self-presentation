...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "teo-self-presentation")
...
if(WIN32 AND CMAKE_GENERATOR MATCHES "^Visual Studio")
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "teo-self-presentation_${CPACK_PACKAGE_VERSION}_${CPACK_SYSTEM_NAME}")

    # Miscellanea.
    set(CPACK_NSIS_HELP_LINK "http://github.com/roboticslab-uc3m/teo-self-presentation/")
...
if(UNIX)
    ...
    # Package name.
    set(CPACK_PACKAGE_FILE_NAME "teo-self-presentation-${CPACK_PACKAGE_VERSION}.${CPACK_SYSTEM_NAME}")
endif()
