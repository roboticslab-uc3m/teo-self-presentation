...
namespace
{
    ...
    const std::unordered_map<std::string, std::string> englishSentences = {
        ...
        {"composition_02", "I have 28 degrees, of freedom, that allow me to move freely, being able to do, such human tasks as walking, identifiying and manipulating objects, doing household chores, ironing, serving as a waiter, etc."},
        ...
        {"composition_05_01", "The computer on my right, serves me, to capture and process the data collected by my sensors."},
        {"composition_05_02", "While, the one on my left, is dedicated, to the tasks of, matipulation and locomotion. It is the computer that plans and gives life to each of my movements"},
